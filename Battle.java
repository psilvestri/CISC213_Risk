...
public class Battle {
	...
	static int attackingUnits = 0; /// Declare variable that will represent available units from attacking
									// territory.
	static int defendingUnits = 0; // Declare variable that will represent available units from defending
									// territory.
	static int attackingUnitsLost = 0;
	static int defendingUnitsLost = 0;

	public static void setUnits() {
		attackingUnits = Territory.getUnits(); // getUnits from territory A (attacking)
		defendingUnits = Territory.getUnits(); // getUnits from territory B (defending)
	}
	...
	public static void fight() {
		...
		System.out.println(attackingUnitsLost);
		System.out.println(defendingUnitsLost);
