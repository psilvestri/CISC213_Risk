...
public interface TerritoryFinals {
	...
	/*
	 * The points of the polygons, labels and the territory adjacency will not
	 * change throughout the game. Because they will not change they are stored in
	 * this interface to save space. This interface is implemented by the territory
	 * class and these values are used to draw the game board and to determine
	 * adjacency.
	 */
	final Double[][] points = {
			// x //y //x //y //x //y //x //y
			...
			// 4
			/* delta */{ 490.0, 215.0, 550.0, 150.0, 725.0, 300.0, 675.0, 325.0, 650.0, 300.0, 625.0, 310.0, 650.0,
					340.0, 620.0, 350.0 },

			// 5
			/* echo */{ 100.0, 250.0, 100.0, 260.0, 110.0, 300.0, 100.0, 340.0, 200.0, 485.0, 250.0, 400.0, 210.0,
					360.0, 210.0, 350.0, 220.0, 350.0, 220.0, 320.0, 160.0, 320.0, 180.0, 280.0, 180.0, 270.0, 170.0,
					250.0 },

			// 6
			/* fox trot */{ 190.0, 150.0, 170.0, 180.0, 170.0, 250.0, 180.0, 270.0, 180.0, 280.0, 160.0, 320.0, 220.0,
					320.0, 220.0, 350.0, 260.0, 350.0, 260.0, 150.0 },
			...
			// 9
			/* M */{ 860.0, 20.0, 1060.0, 60.0, 1100.0, 130.0, 1030.0, 150.0, 950.0, 200.0, 960.0, 120.0, 900.0,
					100.0 },
			...
			// 19
			/* Whiskey */{ 400.0, 575.0, 635.0, 575.0, 725.0, 790.0, 690.0, 825.0, 640.0, 810.0, 565.0, 650.0, 515.0,
					610.0, 400.0, 600.0 } };
	Double[][] labelPoints = { { 415.0, 124.16666666666667 }, // a
			{ 462.5, 322.5 }, // b
			{ 582.0, 357.0 }, // c
			{ 623.125, 286.25 }, // d
	...
	boolean[][] adjacency = {
			...
			// beta
			// alpha beta** char delta echo fox golf L M No O Papa Q R S T U V Whiskey
			{ true, false, true, true, false, false, true, false, false, false, false, false, false, false, false, true,
					true, true, false },
			...
			// Papa
			// alpha beta char delta echo fox golf L M No O Papa Q R S T U V Whiskey
			{ false, false, false, false, false, false, false, false, false, true, true, false, true, true, true, false,
					false, false, false },
